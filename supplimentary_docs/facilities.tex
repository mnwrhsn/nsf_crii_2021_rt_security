...
The PI directs the Cyber-Physical Systems Security Research Lab (CPS2RL).\footnote[1]{\url{https://cps2rl.github.io}.} This 800 square feet lab is located on WSU's main campus in Wallace Hall, Room 331. The proposed research activities will be conducted in this lab. The lab contains various evaluation platforms, including multiple embedded development boards (ZedBoard, LPCXpresso, Zynq UltraScale+,  Raspberry Pi, BeagleBone Black, and UP Extreme), one FischerTechnik manufacturing testbed, and four 3D printers. The lab also includes four general-purpose workstations (2.4 GHz CPU, 8 GB RAM, and 256 GB solid-state hard drive) running Windows 10 and necessary research spaces for graduate and undergraduate students. The students will use these development boards and workstations for simulations, prototype development, and experiments. The lab is available 24/7 for the PI and students.
...
The PI will leverage WSU's existing outreach programs (\eg Shocker Engineering Academy and Security Education Hub) and work on broadening participation in computing (refer to the attached collaboration letters). These resources are not included in the budget.
...
\paragraph{Startup Support.} The PI has \$50,000 startup support for purchasing research equipment. The PI will use \$5500 from this startup funds to purchase additional hardware  required for this project: \ca ground rover and robotic arm testbeds (\$3000) and \cb a high-end desktop computer for the PhD student (\$2500).
