...
The PI will leverage WSU's existing outreach programs (\eg Shocker Engineering Academy and Security Education Hub) and work on broadening participation in computing (refer to the attached support letters). These resources are not included in the budget.
