...
The proposed techniques will be evaluated on various platforms --- from simulation engines to real hardware (automated rovers and a scale-down robot testbed).
