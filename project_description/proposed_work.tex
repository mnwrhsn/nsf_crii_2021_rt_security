...
\ciii How the reactive security mechanisms (say PASSIVE-to-ACTIVE and vice-versa) will be implemented in practice in the real-time OS/scheduler? What is the scheduling/context switch overhead of the mode-switch? 
