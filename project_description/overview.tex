...
\cite{xie2007improving,lin2009static,lesi2017network,lesi2017security,sg1,sg2,sibin_RT_security_journal, zhang2013design, jiang2013optimization, taskshuffler, mhasan_reorder_tech_report, schedguard_rtas21} on reconciling the addition of
...
analysis if we set arbitrary high-priority or small inter-arrival duration, this may violate timing constraints for the critical real-time tasks --- thus the main safety requirements of the system will be threatened.  Unlike single core systems, integrating security into multicore platforms is more challenging since the designers now have multiple choices for where to allocate the security tasks. For instance, should the engineers: 
